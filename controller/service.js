...
//     if (!req.file || !name) {
//       return res.status(200).send({ status: 400, message: "Name and image are required!" });
//     }
...
//     if (!serviceData) {
//       return res.status(200).send({ status: 404, message: "Service not found!" });
//     }
...
//     if (!service_id || !name) {
//       return res.status(400).send({ status: 400, message: "Service ID and name are required!" });
//     }
...
//     if (!service_id) {
//       return res.status(400).send({ status: 400, message: "Service ID is required!" });
//     }
...
//     return res.status(200).send({ status: 200, message: "Service deleted successfully" });
//   } catch (error) {
