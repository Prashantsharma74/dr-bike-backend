...
// // /* POST users listing. */
// // router.get('/paymentrequest',paymentRequest);
...
// // // router.get('/payments/dealer/:dealerId', paymentController.getPaymentsByDealer);
...
// // // router.post('/payment/generate-qr', paymentController.generatePaymentQR);
...
// // // // Payment Management
// // // router.post('/payment/refund', paymentController.initiateRefund);
...
const express = require('express');
const router = express.Router();
const { getAllPayments, initiatePayment, getPaymentById } = require("../controller/payment");
